...
test_cases: List[Tuple[ChatCompletionDeployment, bool, bool]] = [
    ...
    (ChatCompletionDeployment.META_LLAMA3_1_70B_INSTRUCT_V1_US, True, True),
    (ChatCompletionDeployment.META_LLAMA3_1_405B_INSTRUCT_V1, True, True),
    (ChatCompletionDeployment.META_LLAMA3_1_405B_INSTRUCT_V1_US, True, True),
    (ChatCompletionDeployment.META_LLAMA3_3_70B_INSTRUCT_V1, True, True),
