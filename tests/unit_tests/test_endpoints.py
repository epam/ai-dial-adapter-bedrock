...
test_cases: List[Tuple[ChatCompletionDeployment, bool, bool]] = [
    ...
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_SONNET_US, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_SONNET_EU, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_5_SONNET, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_5_SONNET_US, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_5_SONNET_EU, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_HAIKU, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_HAIKU_US, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_HAIKU_EU, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_OPUS, False, False),
    (ChatCompletionDeployment.ANTHROPIC_CLAUDE_V3_OPUS_US, False, False),
