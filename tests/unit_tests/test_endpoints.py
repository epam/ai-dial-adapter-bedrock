...
test_cases: List[Tuple[D, bool, bool, bool]] = [
    ...
    (D.ANTHROPIC_CLAUDE_V3_SONNET, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_SONNET_US, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_SONNET_EU, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_5_SONNET, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_5_SONNET_US, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_5_SONNET_EU, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_5_SONNET_V2, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_5_SONNET_V2_US, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_HAIKU, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_HAIKU_US, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_HAIKU_EU, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_5_HAIKU, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_5_HAIKU_US, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_OPUS, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_OPUS_US, True, True, False),
    (D.ANTHROPIC_CLAUDE_V3_7_SONNET_US, True, True, True),
    (D.STABILITY_STABLE_DIFFUSION_XL, False, True, False),
    (D.STABILITY_STABLE_DIFFUSION_XL_V1, False, True, False),
    (D.STABILITY_STABLE_DIFFUSION_3_LARGE_V1, False, True, False),
    (D.STABILITY_STABLE_IMAGE_ULTRA_V1, False, True, False),
    (D.STABILITY_STABLE_IMAGE_CORE_V1, False, True, False),
    ...
    (D.META_LLAMA3_1_70B_INSTRUCT_V1_US, True, True, False),
    (D.META_LLAMA3_1_405B_INSTRUCT_V1, True, True, False),
    (D.META_LLAMA3_1_405B_INSTRUCT_V1_US, True, True, False),
