...
test_cases: list[tuple[D, bool, bool, bool]] = [
    ...
    (D.ANTHROPIC_CLAUDE_V5_OPUS, True, True, True),
    (D.ANTHROPIC_CLAUDE_V4_5_HAIKU, True, True, True),
    (D.ANTHROPIC_CLAUDE_V4_5_HAIKU_MANTLE, True, True, True),
    (D.ANTHROPIC_CLAUDE_V4_5_SONNET, True, True, True),
    (D.ANTHROPIC_CLAUDE_V4_6_SONNET, True, True, True),
    (D.ANTHROPIC_CLAUDE_V5_SONNET, True, True, True),
    (D.ANTHROPIC_CLAUDE_V5_FABLE, True, True, True),
    (D.STABILITY_STABLE_DIFFUSION_3_5_LARGE_V1, False, True, True),
    (D.STABILITY_STABLE_IMAGE_ULTRA_V1, False, True, True),
    (D.STABILITY_STABLE_IMAGE_ULTRA_V1_1, False, True, True),
    (D.STABILITY_STABLE_IMAGE_CORE_V1_1, False, True, True),
    (D.META_LLAMA3_8B_INSTRUCT_V1, True, True, True),
    (D.META_LLAMA3_70B_INSTRUCT_V1, True, True, True),
    (D.META_LLAMA3_1_8B_INSTRUCT_V1, True, True, True),
    (D.META_LLAMA3_1_70B_INSTRUCT_V1, True, True, True),
    (D.META_LLAMA3_1_405B_INSTRUCT_V1, True, True, True),
    (D.META_LLAMA3_3_70B_INSTRUCT_V1, True, True, True),
    (D.META_LLAMA3_2_1B_INSTRUCT_V1, True, True, True),
