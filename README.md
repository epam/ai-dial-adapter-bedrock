...
|CONVERSE_API_REQUEST_METADATA_FIELDS|NA|Comma-separated list of DIAL User information fields to include in Converse API request metadata, for example `roles,project,userClaims`. Leave empty to disable or use `*` to include all supported fields.|
